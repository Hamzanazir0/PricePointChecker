...
<body class="min-h-screen bg-base [background-image:linear-gradient(0deg,transparent_24%,rgba(114,114,114,0.3)_25%,rgba(114,114,114,0.3)_26%,transparent_27%,transparent_74%,rgba(114,114,114,0.3)_75%,rgba(114,114,114,0.3)_76%,transparent_77%,transparent),linear-gradient(90deg,transparent_24%,rgba(114,114,114,0.3)_25%,rgba(114,114,114,0.3)_26%,transparent_27%,transparent_74%,rgba(114,114,114,0.3)_75%,rgba(114,114,114,0.3)_76%,transparent_77%,transparent)] [background-size:55px_55px]">
            ...
            <div class="fixed top-4 right-4">
                <div class="flex-none">
                    <select id="themeSwitcher" class="select select-bordered select-sm">
                        <option value="sunset" selected>Default - Dark</option>
                        <option value="wireframe">Wireframe - Light</option> <!-- Light -->
                        <option value="sunset">Sunset - Dark</option> <!-- Dark -->
                        <option value="synthwave">Synthwave</option>
                        <option value="business">Business - Dark</option> <!-- Dark -->
                        <option value="pastel">Pastel - Light</option> <!-- Light -->
                        <option value="halloween">Halloween - Dark</option> <!-- Dark -->
                        <option value="bumblebee">Bumblebee - Light</option> <!-- Light -->
                        <option value="forest">Forest - Dark</option> <!-- Dark -->
                    </select>
                </div>
            </div>

            <div class="fixed bottom-[unset] top-6 right-6 fab">
                <!-- Main FAB button -->
                <!-- <div tabindex="0" role="button" class="badge badge-lg badge-primary mb-2 cursor-pointer">
                    Change Theme
                </div> -->

                <div tabindex="0" role="button" class="!flex flex-row bg-base-100 group-hover:border-base-content/20 border-base-content/10 rounded-md border p-1 px-3 transition-colors cursor-pointer mb-2">
                    <div class=" grid shrink-0 grid-cols-2 gap-0.5 p-1 transition-colors">
                        <div class="bg-base-content size-1 rounded-full"></div>
                        <div class="bg-primary size-1 rounded-full"></div>
                        <div class="bg-secondary size-1 rounded-full"></div>
                        <div class="bg-accent size-1 rounded-full"></div>
                    </div>
                    <div class="select-none">Change Theme</div>
                ...
                <!-- Theme buttons -->
                <button data-theme="sunset" class="btn btn-sm btn-accent">Default - Dark</button>
                <button data-theme="wireframe" class="btn btn-sm btn-neutral">Wireframe - Light</button>
                <button data-theme="sunset" class="btn btn-sm btn-secondary">Sunset - Dark</button>
                <button data-theme="synthwave" class="btn btn-sm btn-info">Synthwave</button>
                <button data-theme="business" class="btn btn-sm btn-success">Business - Dark</button>
                <button data-theme="pastel" class="btn btn-sm btn-warning">Pastel - Light</button>
                <button data-theme="halloween" class="btn btn-sm btn-error">Halloween - Dark</button>
                <button data-theme="bumblebee" class="btn btn-sm btn-error">Bumblebee - Light</button>
                <button data-theme="forest" class="btn btn-sm btn-error">Forest - Dark</button>
            </div>
    ...
    <script>
        ...
        themeSwitcher.addEventListener("change", function() {
            const selectedTheme = this.value || defaultTheme;
